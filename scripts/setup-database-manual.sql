-- Script SQL para deshabilitar RLS temporalmente e insertar datos
...
('Programowanie', 'programowanie', 'Tutoriale i wskazówki programistyczne', '#8B5CF6');

-- Insertar autores (Natalia Sikora)
INSERT INTO authors (name, email, bio, avatar_url, social_links) VALUES
('Natalia Sikora', 'natalia@metablog.pl', 'Ekspertka w dziedzinie technologii i programowania. Pasjonuje się nowoczesnymi rozwiązaniami AI i ich zastosowaniem w codziennym życiu.', 'https://images.unsplash.com/photo-1494790108755-2616b612b77c?w=400&h=400&fit=crop&crop=face', '{"twitter": "natalia_sikora", "linkedin": "natalia-sikora", "instagram": "natalia.tech"}');

-- Insertar posts de ejemplo
INSERT INTO posts (title, slug, excerpt, content, image_url, author_id, category_id, published, meta_title, meta_description, tags, reading_time, views) VALUES
...
'["AI", "Sztuczna Inteligencja", "Technologia", "Przyszłość", "Innowacje"]',
4, 0),
...
'["Programowanie", "Kariera", "Python", "JavaScript", "Nauka"]',
6, 0),
...
'["Work-Life Balance", "IT", "Kariera", "Zdrowie", "Produktywność"]',
5, 0);

-- Ponownie włączyć RLS (opcjonalne)
