...
export const metadata = {
   ...generateBlogPostMeta({
      title: 'Wpływ Technologii na Miejsce Pracy | MetaBlog',
      description: 'Analiza wpływu nowoczesnej technologii na środowisko pracy i przyszłość zawodów',
      author: 'Jakub Wiśniewski',
      publishedTime: '2025-09-20T10:00:00Z',
      url: 'https://yourdomainname.com/single-post',
      tags: ['technologia', 'praca', 'AI', 'przyszłość'],
      category: 'Technology'
   })
}
const SinglePost = () => {
   return (
      <>
         <ArticleSchema
            headline="Wpływ Technologii na Miejsce Pracy: Jak Technologia Zmienia"
            description="Analiza wpływu nowoczesnej technologii na środowisko pracy i przyszłość zawodów"
            author={{ name: "Jakub Wiśniewski", url: "https://yourdomainname.com/author" }}
               ...
               <div className="font-serif">
                  ...
                  <div className="flex items-center justify-center my-8 font-work">
                     <div className="py-4 bg-base-content/10 text-base-content/60 text-center rounded-xl w-11/12">
                        <p className="text-sm">Reklama</p>
                        <h6 className="text-xl font-semibold leading-[24px]">
                           Tutaj możesz umieścić reklamę
                        </h6>
